  ...
  <div class="container py-4">
    <div class="p-5 mb-4 bg-light rounded-3">
      <div class="container-fluid py-5">
        ...
        <a href="../index.php" class="btn btn-warning btn-lg">View available equipment</a>
      </div>
    </div>
    ...
    <div class="row align-items-md-stretch">
      <div class="col-md-6">
        <div class="h-100 p-5 text-white bg-dark rounded-3">
          ...
          <a href="#" class="btn btn-outline-light">More questions? FAQ</a>
        </div>
      </div>
      <div class="col-md-6">
        <div class="h-100 p-5 bg-light rounded-3">
          <h2>Contact us</h2>
          <p>If the item you need is not listed, please send us a message through the special item request form below.</p>
          <a href="" class="btn btn-outline-secondary">Special item request form</a>
        </div>
      </div>
    </div>
  </div>
